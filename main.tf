...
module "xray" {
  source = "git::https://github.com/Govin87/terra-infra-mods.git//modules/monitoring?ref=main"
}

module "cloudwatch" {
  source = "git::https://github.com/Govin87/terra-infra-mods.git//modules/observability?ref=main"
}
